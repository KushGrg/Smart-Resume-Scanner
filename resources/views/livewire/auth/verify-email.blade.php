...
<div class="md:w-96 mx-auto mt-20">
    <x-card class="shadow-xl">
        ...
        <x-card title="Verify Your Email"
            subtitle="{{ auth()->user()->previously_verified ? 'You\'ve changed your email address! Please verify your new email address before regaining access to your account.' : 'Thanks for signing up! Before getting started, could you verify your email address by clicking on the link we just emailed to you?' }}">
            @if (session('message'))
